...
describe("Login Page", () => {
  ...
  it("10. Buy a T-shirt", ()=>{
    ...
    // - Click “Checkout”
    PaymentPage.Button_CartCheckout.click()
    // - Fill in First name
    PaymentPage.Input_UserFirstName.type("Deniss")
    // - Fill in Last name
    PaymentPage.Input_UserLastName.type("Belinskis")
    // - Fill in ZIP/Postal code
    PaymentPage.Input_UserPostalCode.type("LV-1212")
    // - Click Continue
    PaymentPage.Button_PaymentContinue.click()
    // - Validate item name “Test.allTheThings() T-Shirt (Red)”
    PaymentPage.Validate_PaymentItem.should("contain.text", "Test.allTheThings() T-Shirt (Red)")
    // - Click “Finnish”
    PaymentPage.Button_PaymentFinish.click()
    // - Validate header “THANK YOU FOR YOUR ORDER”
    PaymentPage.Validate_SuccessfulOrder.should("have.text", "THANK YOU FOR YOUR ORDER")
